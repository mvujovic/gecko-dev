                                                ...
                                                nsTArray<RefPtr<SourceSurface>>& aInputImages)
{
  ...
  IntRect firstPeriodInFilterSpace =
    aInstance->UserSpaceToFilterSpace(firstPeriodInUserSpace);
  Size frequencyInFilterSpace(1.0 / firstPeriodInFilterSpace.Width(),
                              1.0 / firstPeriodInFilterSpace.Height());
  IntPoint offset = firstPeriodInFilterSpace.TopLeft();

  FilterPrimitiveDescription descr(FilterPrimitiveDescription::eTurbulence);
  descr.Attributes().Set(eTurbulenceOffset, offset);
